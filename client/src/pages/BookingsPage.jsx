        ...
        {bookings?.length > 0 ? (
          bookings.map((booking) => (
            <Link
              ...
              className="mx-4 lg:mx-0 flex gap-4 bg-slate-100 text-black rounded-2xl overflow-hidden my-8 h-28 md:h-40"
              key={booking._id}
            >
          ...
          <div className="">
            <div className="flex flex-col justify-start">
              ...
              <Link to="/" className="my-4">
                <div className="flex justify-center w-40 p-3 border bg-slate-100 text-black border-black rounded-3xl rounded-lg font-semibold text-lg hover:bg-slate-400">
                  Start Searching
                </div>
              </Link>
            </div>
