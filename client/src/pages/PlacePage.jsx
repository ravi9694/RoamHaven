...
const PlacePage = () => {
  ...
  return (
    <div className="mt-4 bg-black text-slate-100 px-8 pt-20 overflow-x-hidden ">
      ...
      <div className="bg-black text-white -mx-8 px-8 py-8 border-t">
        <div>
          <h2 className="font-semibold text-2xl mt-4">Extra Info</h2>
        </div>
        <div className="text-sm text-white bg-black leading-5 mb-4 mt-2">
          {place.extraInfo}
        </div>
      </div>
    </div>
