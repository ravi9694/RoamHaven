      ...
      <div className="flex w-4/6 md:w-1/2 bg-gray-300 border border-gray-400 rounded-full overflow-hidden shadow-sm hover:shadow-lg">
        <div className="grow">
          <input
            ...
            className="w-full h-full py-2 px-4 border-none text-black focus:outline-none  text-sm md:text-lg"
            onChange={(e) => handleSearch(e)}
            value={searchText}
          />
        </div>
        <div className="flex items-center bg-secondary text-black cursor-pointer">
          <button
            className="flex py-2 px-4 md:p-2 bg-secondary rounded-r-full"
