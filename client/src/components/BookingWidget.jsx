...
const BookingWidget = ({ place }) => {
  ...
  return (
    <div className="bg-black text-white shadow p-4 rounded-2xl">
        ...
        <div className="flex justify-center">
          <div className="py-3 px-4">
            ...
            <input
              ...
              className="w-20 rounded-lg p-1 bg-slate-100 text-black sm:w-auto"
            />
          </div>
          <div className="py-3 px-4">
            ...
            <input
              ...
              className="w-20 rounded-lg p-1 sm:w-auto bg-slate-100 text-black"
            />
          </div>
        </div>
